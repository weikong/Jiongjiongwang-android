...
/**
 * Created by xinzhendi-031 on 2016/11/7.
 */
public class OkHttpClientManager {
     ...
     * @param callback
     */
    public void _getAsyn(String url, final StringCallback callback) {
        final Request request = new Request.Builder()
                .url(url)
                .build();
     ...
     * @return
     */
    public Response _post(String url, Param... params) throws IOException {
     ...
     * @param params
     */
    public void _postAsyn(String url, final StringCallback callback, Param... params) {
        Request request = buildPostRequest(url, params);
        deliveryResult(callback, request);
    }
     ...
     * @throws IOException
     */
    public void _postAsyn(String url, StringCallback callback, File file, String fileKey) throws IOException {
        Request request = buildMultipartFormRequest(url, new File[]{file}, new String[]{fileKey}, null);
        deliveryResult(callback, request);
    }
     ...
     * @throws IOException
     */
    public void _postAsyn(String url, StringCallback callback, File file, String fileKey, Param... params) throws IOException {
        Request request = buildMultipartFormRequest(url, new File[]{file}, new String[]{fileKey}, params);
        deliveryResult(callback, request);
    }
