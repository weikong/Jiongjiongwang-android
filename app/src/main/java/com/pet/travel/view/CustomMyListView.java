...
public class CustomMyListView extends ListView {
    ...
    public CustomMyListView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CustomMyListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
